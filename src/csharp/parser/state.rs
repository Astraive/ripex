...
pub struct Parser {
    ...
    pub depth: u32,
    #[allow(dead_code)]
    current_visibility: super::super::ast::stmt::Visibility,
}
...
impl Parser {
    pub fn new(source: &str) -> Self {
        if source.len() > MAX_INPUT_SIZE {
            ...
            return Parser {
                ...
                depth: 0,
                current_visibility: super::super::ast::stmt::Visibility::None,
            };
        }
    ...
    /// is empty (e.g. input larger than `MAX_INPUT_SIZE`). Safe when empty.
